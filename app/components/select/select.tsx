...
export default function Select({selectDayofWeek}:SelectProps){
    return (
        <div className="w-full">
            ...
            <select defaultValue="0" onChange={selectDayofWeek} className="w-full border outline-none border-slate-300/80 focus:ring-2 duration-300 px-4 focus:ring-blue-400 py-2 rounded-[5px]" id="eventday" name="daysoftheweek">
