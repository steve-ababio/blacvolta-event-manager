    ...
    return(
        <div className={`w-full ${disabled ? 'opacity-50': ''} pb-4`}>
            ...
            <input 
                ...
                disabled={disabled} 
                onChange={onChange} 
                className={twMerge(`border dark:text-slate-200 dark:bg-transparent mb-2 disabled:cursor-not-allowed border-slate-300/80 focus:ring-2 outline-none text-slate-600 duration-300 px-4 dark:focus:ring-white focus:ring-black rounded-[5px] w-full py-2`,className)}
